...
var determinedGetUrl = "lib.php?action=random&rank=";  	 // Set to URL of the server-side process to load via ajax when spinMode is determinedAngle or determinedPrize.
/*
...
// ==================================================================================================================================================
function begin(userRank,fbid)
{
	// Get our Canvas element
	surface = document.getElementById(canvasId);
	determinedGetUrl=determinedGetUrl+userRank+'&fbid='+fbid;
